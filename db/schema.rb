...
ActiveRecord::Schema.define(version: 2019_10_30_190348) do
  ...
  create_table 'articles', force: :cascade do |t|
    ...
    t.bigint 'topics_id'
    t.bigint 'sources_id'
    t.index %w[sources_id], name: 'index_articles_on_sources_id'
    t.index %w[topics_id], name: 'index_articles_on_topics_id'
  end
  ...
  create_table 'filters', force: :cascade do |t|
    ...
    t.bigint 'users_id'
    t.bigint 'sources_id'
    t.index %w[sources_id], name: 'index_filters_on_sources_id'
    t.index %w[users_id], name: 'index_filters_on_users_id'
  end
  ...
  create_table 'subscriptions', force: :cascade do |t|
    ...
    t.bigint 'users_id'
    t.bigint 'topics_id'
    t.index %w[topics_id], name: 'index_subscriptions_on_topics_id'
    t.index %w[users_id], name: 'index_subscriptions_on_users_id'
  end
